		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comerosdisplaytransaction-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comerosdisplaytransaction-display": {
								"semanticObject": "comerosdisplaytransaction",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.eros.displaytransaction",
									"url": sap.ui.require.toUrl("com/eros/displaytransaction")
								}
							}
						}
					}
